...
//! against a real `chisl_app::create_router_with_states` instance backed by
...
use chisl_app::{AppConfig, AppServices, ModuleStates, build_module_states, create_router_with_states};
...
async fn fixture() -> Fixture {
    ...
    provider_repo
        .create(chisl_db::CreateProviderParams {
            id: None,
            platform: "openai",
            name: "Test OpenAI",
...
async fn list_requires_auth() {
    ...
    // (see `chisl_auth::middleware::auth_middleware`).
