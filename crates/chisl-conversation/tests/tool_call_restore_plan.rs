...
use chisl_db::models::OpencodeToolSnapshotRow;
use chisl_db::{SqliteConversationRepository, init_database_memory};
...
async fn setup_with_pool() -> (ConversationService, chisl_db::SqlitePool) {
...
async fn restore_plan_round_trip_returns_read_only_preview() {
    ...
    assert_eq!(entry.operation, chisl_api_types::RestorePathOperation::Modify);
