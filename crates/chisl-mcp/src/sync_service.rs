...
use chisl_api_types::{DetectedMcpServerResponse, McpAgentSyncResult, McpSyncResult};
...
fn detected_to_response(detected: DetectedServer) -> chisl_api_types::McpServerResponse {
    chisl_api_types::McpServerResponse {
        ...
        tools: None,
        status: chisl_common::McpServerStatus::Disconnected,
        last_connected: None,
        original_json: None,
        builtin: false,
        created_at: 0,
...
mod tests {
    ...
    use chisl_common::{McpServerStatus, TimestampMs};
    use chisl_db::models::McpServerRow;
    use chisl_db::{CreateMcpServerParams, DbError, UpdateMcpServerParams};
