...
use chisl_mcp::{AionuiAdapter, McpAgentAdapter, McpServerTransport};
...
mod aionui {
    ...
    use chisl_db::{CreateMcpServerParams, DbError, IMcpServerRepository, UpdateMcpServerParams};
    ...
    impl IMcpServerRepository for MockRepo {
        ...
        async fn update_status(
            ...
            _id: &str,
            _s: &str,
            _lc: Option<chisl_common::TimestampMs>,
        ) -> Result<(), DbError> {
            unimplemented!()
        }
