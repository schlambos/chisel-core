...
mod telegram_tests {
    ...
    use chisl_channel::manager::{ChannelManager, PluginFactory};
    use chisl_channel::plugin::ChannelPlugin;
    use chisl_channel::plugins::telegram::TelegramPlugin;
    use chisl_channel::types::{PluginConfig, PluginCredentials, PluginStatus, PluginType};
