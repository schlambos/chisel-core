...
//!
//! These tests exercise the public API surface of `chisl_extension::skill_service`
//! and `chisl_extension::external_paths` against the functional requirements in
//! `08-file-workspace.md` §B.

use std::path::Path;

use chisl_extension::external_paths::ExternalPathsManager;
use chisl_extension::skill_service::{
