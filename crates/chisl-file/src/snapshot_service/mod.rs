...
use chisl_common::{AppError, FileChangeOperation};
use dashmap::DashMap;
use git2::Repository;
...
impl SnapshotService {
    ...
    pub async fn workspace_vcs_status(
        &self,
        workspace: &str,
    ) -> Result<chisl_api_types::WorkspaceVcsResponse, AppError> {
        use chisl_api_types::{FileDiffEntryResponse, WorkspaceVcsResponse, WorkspaceVcsSummary};
        use git2::Repository;
            ...
            let patches: Vec<FileDiffEntryResponse> = entries
                ...
                .map(|e| {
                    ...
                    FileDiffEntryResponse {
                        ...
                        // Decouple the response from `chisl-common`'s
