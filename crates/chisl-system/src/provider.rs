...
use chisl_api_types::{CreateProviderRequest, ProviderResponse, UpdateProviderRequest};
use chisl_common::{AppError, decrypt_string, encrypt_string};
use chisl_db::{CreateProviderParams, IProviderRepository, UpdateProviderParams, models::Provider};
...
mod tests {
    use super::*;
    use chisl_db::{SqliteProviderRepository, init_database_memory};
    ...
    fn validate_create_bedrock_allows_empty_base_url_and_api_key() {
        let req = CreateProviderRequest {
            ...
            base_url: "".into(),
            api_key: "".into(),
            bedrock_config: Some(chisl_api_types::BedrockConfig {
                auth_method: chisl_api_types::BedrockAuthMethod::Profile,
