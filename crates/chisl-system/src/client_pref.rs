...
use chisl_api_types::{ClientPreferencesResponse, UpdateClientPreferencesRequest};
use chisl_common::AppError;
use chisl_db::IClientPreferenceRepository;
...
mod tests {
    use super::*;
    use chisl_db::{SqliteClientPreferenceRepository, init_database_memory};
    use serde_json::json;
