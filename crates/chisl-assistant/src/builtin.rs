...
//!    (`~/.cargo/bin/chislcore` → `target/debug/chislcore`) and
...
/// `crates/chisl-app/assets/builtin-assistants/`.
static BUILTIN_ASSETS: Dir<'_> = include_dir!("$CARGO_MANIFEST_DIR/../chisl-app/assets/builtin-assistants");
