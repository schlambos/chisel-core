...
use chisl_common::{AppError, now_ms};
use chisl_db::{
...
use chisl_extension::{AssistantClassifier, AssistantRuleDispatcher, ExtensionRegistry, ResolvedAssistant};
use serde_json;
    ...
    pub async fn import(&self, req: ImportAssistantsRequest) -> Result<ImportAssistantsResult, AppError> {
        ...
        for entry in req.assistants {
            ...
            match self.repo.create(&params).await {
                ...
                Err(chisl_db::DbError::Conflict(_)) => {
...
mod tests {
    ...
    use chisl_extension::ExtensionStateStore;
