...
use chisl_api_types::AcpBuildExtra;
use chisl_common::{AppError, CommandSpec};
use chisl_db::IMcpServerRepository;
use chisl_db::models::McpServerRow;
...
mod tests {
    ...
    impl IMcpServerRepository for MockRepo {
        async fn list(&self) -> Result<Vec<McpServerRow>, chisl_db::DbError> {
            if self.fail {
                Err(chisl_db::DbError::Init("simulated".into()))
            } else {
                Ok(self.rows.clone())
            }
        }
        async fn find_by_id(&self, _id: &str) -> Result<Option<McpServerRow>, chisl_db::DbError> {
            unimplemented!()
        }
        async fn find_by_name(&self, _name: &str) -> Result<Option<McpServerRow>, chisl_db::DbError> {
            unimplemented!()
        }
        async fn create(
            &self,
            _params: chisl_db::CreateMcpServerParams<'_>,
        ) -> Result<McpServerRow, chisl_db::DbError> {
            unimplemented!()
        }
        async fn update(
            &self,
            _id: &str,
            _params: chisl_db::UpdateMcpServerParams<'_>,
        ) -> Result<McpServerRow, chisl_db::DbError> {
            unimplemented!()
        }
        ...
        async fn batch_upsert(
            &self,
            _servers: &[chisl_db::CreateMcpServerParams<'_>],
        ) -> Result<Vec<McpServerRow>, chisl_db::DbError> {
            unimplemented!()
        }
        async fn update_status(
            ...
            _id: &str,
            _status: &str,
            _last_connected: Option<chisl_common::TimestampMs>,
        ) -> Result<(), chisl_db::DbError> {
            unimplemented!()
        }
        async fn update_tools(&self, _id: &str, _tools: Option<&str>) -> Result<(), chisl_db::DbError> {
            unimplemented!()
        }
    }
