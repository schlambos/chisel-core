...
/// Apply the same environment sanitization as chisl_runtime::Builder
...
impl TerminalSession {
    ...
    pub fn new(command: Option<String>, cwd: Option<String>, cols: u16, rows: u16) -> Result<Self, String> {
        ...
        // Build the command with chisl_runtime's env sanitization
        let mut cmd_builder = CommandBuilder::new(&shell_path);

        // Apply same env sanitization as chisl_runtime::Builder
