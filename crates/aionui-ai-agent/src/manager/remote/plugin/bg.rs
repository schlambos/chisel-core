...
use aionui_api_types::BgProcessUiInfo;
...
pub fn bg_info_to_ui(info: BgProcessInfo) -> BgProcessUiInfo {
    BgProcessUiInfo {
        ...
        status: match info.status {
            BgStatus::Running => aionui_api_types::BgProcessStatus::Running,
            BgStatus::Exited => aionui_api_types::BgProcessStatus::Exited,
            BgStatus::Killed => aionui_api_types::BgProcessStatus::Killed,
        },
