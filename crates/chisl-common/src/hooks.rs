...
//!
//! Hooks defined here let lower-layer crates (e.g. `chisl-ai-agent`,
//! `chisl-cron`) react to events owned by higher-layer crates (e.g.
//! `chisl-conversation`) without forming a dependency cycle.
