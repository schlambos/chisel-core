...
use chisl_db::{DbError, IChannelRepository, SqliteChannelRepository, UpdatePluginStatusParams, init_database_memory};

async fn repo() -> (Arc<dyn IChannelRepository>, chisl_db::Database) {
